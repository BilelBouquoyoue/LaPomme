...
import { getTransactionsH } from '../../actions/transactions';
...
const Transactions = (
    {
        getTransactionsH, transaction: {transactions, loading}
    }
    ) => {
        ...
        //console.log(all)
        useEffect(()=>{
            getTransactionsH(tel2);
            setCurrentPage(1);
            setAllPerPage(10);
            setAll(transactions);
        }, [loading, getTransactionsH]);
...
Transactions.propTypes = {
    getTransactionsH: propTypes.func.isRequired,
...
export default connect(mapStateToProps, {getTransactionsH})(Transactions);